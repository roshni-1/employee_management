...
# Function to view employee details and provide growth plan and feedback
def view_employee():
    ...
    # Display employee details and provide feedback based on performance
    ...
    if employee_data:
        ...
        # Provide growth plan based on performance
        if employee_data[6] >= 4:
            text_output.insert(END, "Growth Plan: You are performing exceptionally well!\n")
        elif employee_data[6] >= 3:
            text_output.insert(END, "Growth Plan: Focus on enhancing your skills for more opportunities.\n")
        else:
            text_output.insert(END, "Growth Plan: Consider additional training to improve your skills.\n")

        # Provide feedback based on performance
        if employee_data[6] >= 4:
            text_output.insert(END, "Feedback: Outstanding performance! Keep up the excellent work!\n")
        elif employee_data[6] >= 3:
            text_output.insert(END, "Feedback: Good job! Continue to work on your skills and excel.\n")
        else:
            text_output.insert(END, "Feedback: Your performance needs improvement. Seek additional guidance and training.\n")
    else:
